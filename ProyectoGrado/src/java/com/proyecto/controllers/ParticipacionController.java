...
{  
    @EJB
    private ParticipacionFacade _ejbFacade;
    
    @EJB
    private DocentesFacade docentesFacade;
        
    private Participacion _obj;
    ...
    public Participacion getCampo()
    {  if(_obj==null)  _obj= new Participacion();
        return _obj;        
    }
    ...
    public void abrirCrear() {
        ...
        RequestContext.getCurrentInstance().openDialog("/participacion/crear", options, null);
...
//    }
    ...
    public List<Participacion> getListado()
    {
        Docentes doc = docentesFacade.getCurrentDocente();
...
//        cedula= "109877";
    ...
    public void borrar(Participacion faceObj)
    {
        String titulo,detalle;
...
//            message = new FacesMessage(FacesMessage.SEVERITY_INFO,titulo,detalle);
    ...
    public void abrirActualizar(Participacion objtemp)
    {
        _obj = objtemp;
        Map<String,Object> options = new HashMap<String, Object>();
        options.put("resizable", false);
        options.put("draggable", false);
        options.put("modal", true);       
        RequestContext.getCurrentInstance().openDialog("/participacion/actualizar", options, null);
    }
